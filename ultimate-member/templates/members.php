		...
		<div class="row">
			<div class="filter-col">
				<div class="um-member-directory-header um-form">
					...
					<p>Discover the members in our network!</p>
						...
						<div class="um-member-directory-header-row um-member-directory-search-row">
							<div class="um-member-directory-search-line">
								<label>
									...
									<input type="search" class="um-search-line" value="<?php echo esc_attr( $search_from_url ) ?>" aria-label="<?php esc_attr_e( 'Search', 'ultimate-member' ) ?>" speech />
									<button class="btn-search-cancel">&times;</button>
								</label>
