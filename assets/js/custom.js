...
(function ($) {
  var theme = {
    ...
    bindEvents: function bindEvents() {
      ...
      self.cache.$document.ready(function () {
        ...
        $("body").on("click", ".btn-modal-submit", function (e) {
          e.preventDefault();
          var fields = $("#message-form .form-control"),
            valid = 0;

          _.each(fields, function (el) {
            if (
              (el.value.length < 1 || el.value === "_blank") &&
    ...
    initCards: function initCards() {
      ...
      $("body").on(
        "click",
        ".playercard-item.opened .playercard-front",
        function (e) {
          e.preventDefault();
      ...
      $("body").on(
        "click",
        ".playercard-item.opened .playercard-back .card-body",
        function (e) {
          e.preventDefault();
    ...
    createFullPage: function createFullPage() {
      if ($(window).width() >= 992) {
        $("#fullpage").fullpage({
    ...
    arrangeCards: function arrangeCards() {
      var card = $(".stack-item");
    ...
    initAnimation: function initAnimation() {
      var icon_a = bodymovin.loadAnimation({
      ...
      var icon_b = bodymovin.loadAnimation({
      ...
      var icon_c = bodymovin.loadAnimation({
      ...
      if ($("body").hasClass("home")) {
        $(window).on("scroll", function () {
          var top = jQuery(window).scrollTop(),
            divBottom =
              jQuery(".landing-wrap").offset().top +
              $(".landing-wrap").outerHeight();
